[<img alt="Docker Image Version (tag latest semver)" src="https://img.shields.io/docker/v/lariatdata/install-aws-base/latest">](https://hub.docker.com/repository/docker/lariatdata/install-gcp-base/general)
